...
export default ({history}) => (
    <Container>
        <Header searchBar rounded style = {{height: 70,backgroundColor: 'orange' , color: 'orange', paddingBottom: 10, paddingTop: 10}}>
      ...
      <Header searchBar rounded style = {{backgroundColor:'#49afd7', height: 60, paddingBottom: 10, paddingTop: 10}}>
